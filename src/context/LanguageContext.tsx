...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({
  ...
  const t = (key: string): string => {
    const translations: Record<string, Record<Language, string>> = {
      ...
      "home.concerts.title": {
        fr: "Concerts Chez Bozos",
        en: "Concerts at Bozos",
      },
      ...
      "home.concerts.description": {
        fr: "Découvrez nos concerts intimes dans un lieu chargé d'histoire. Une expérience musicale unique au cœur de Montréal.",
      ...
      "home.musee.description": {
        fr: "Plongez dans l'histoire de la première boîte à chanson d'Amérique. Un musée vivant célébrant le patrimoine musical québécois.",
        en: "Dive into the history of America's first song house. A living museum celebrating Quebec's musical heritage.",
      },
      "home.donation.title": {
        fr: "Faire un don pour la protection du patrimoine musical Québécois",
      ...
      // Footer
      "footer.email": {
        fr: "direction@maisondesbozos.com",
        en: "direction@maisondesbozos.com",
      },
      "footer.address": {
        fr: "1208 Crescent St,\nMontreal, Quebec\nH3G 2A9",
        en: "1208 Crescent St,\nMontreal, Quebec\nH3G 2A9",
